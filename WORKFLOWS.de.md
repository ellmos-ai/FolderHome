...
| **Lokale FolderHome-App starten** [`local-app.de.md`](./workflows/local-app.de.md) | Die gemeinsame FolderHome-Oberfläche auf genau dem aktuellen Betriebssystemkonto starten und vorhandene Dokumentensuche sowie Themendossiers read-o... | pro lokaler Arbeitssitzung | wenige Sekunden zuzüglich der interaktiven Nutzung |
...
| **Strands-Agent und Wettbewerbsdemo ausführen** [`strands-agent.de.md`](./workflows/strands-agent.de.md) | Den echten Strands-Agents-Loop von FolderHome begrenzt planen, mit synthetischen Daten reproduzierbar ausführen und einen hashgebundenen Wettbewerb... | pro Demo- oder Agentenabnahme | wenige Sekunden ohne Bedrock; providerabhängig mit Bedrock |
