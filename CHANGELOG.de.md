...
- Das geprüfte Kostenprofil erlaubt dem Cloud-Master-Agenten sechs statt zwei
  Modellzüge (`FOLDERHOME_AGENTCORE_MAX_TURNS=6`): Zwei Züge decken genau einen
...
- Grundlage der Scheduler-Registrierung: Ein schreibfreier Plan bindet
  ...
  Paketmodule werden abgewiesen. Die private Registrierungs-API sichert jetzt
