...
DEFAULT_KNOWLEDGE_DIGEST_PROVIDER_ROOT = default_provider_root(REPOSITORY_ROOT, "KnowledgeDigest")
DEFAULT_HUNGRYCALL_PROVIDER_ROOT = default_provider_root(REPOSITORY_ROOT, "hungrycall")
DEFAULT_RINGEDINGEDING_PROVIDER_ROOT = default_provider_root(REPOSITORY_ROOT, "ringedingeding")
DEFAULT_AI_MEDIA_EDITOR_ROOT = default_provider_root(REPOSITORY_ROOT, "ai-media-editor")
DEFAULT_DOCS_GRABBER_ROOT = default_provider_root(REPOSITORY_ROOT, "UniversalDocsGrabber")
DEFAULT_UPTODAY_PROVIDER_ROOT = default_provider_root(REPOSITORY_ROOT, "UpToday")
DEFAULT_LLM_NOTE_PROVIDER_ROOT = default_provider_root(REPOSITORY_ROOT, "llm-note")
DEFAULT_TAX_ASSISTANT_PROVIDER_ROOT = default_provider_root(REPOSITORY_ROOT, "steuer-assistent")
