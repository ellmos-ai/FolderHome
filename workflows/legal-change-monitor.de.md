...
[English](./legal-change-monitor.md) | **Deutsch**
...
- [`../docs/phase34-legal-change-monitor-plan.md`](../docs/phase34-legal-change-monitor-plan.de.md)
- [`../skills/folderhome-legal-change-monitor/SKILL.md`](../skills/folderhome-legal-change-monitor/SKILL.md)
- [`../reused/law-checker/README.md`](../reused/law-checker/README.de.md)
- [`./official-notice-understanding.md`](official-notice-understanding.de.md)
