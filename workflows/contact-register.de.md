...
[English](./contact-register.md) | **Deutsch**
...
- [`../docs/phase16-contact-reuse-and-plan.md`](../docs/phase16-contact-reuse-and-plan.de.md)
- [`./document-library.md`](document-library.de.md) — lokale Dokumentextraktion
