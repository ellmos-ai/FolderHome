...
[English](./document-bundle.md) | **Deutsch**
...
- [`../docs/phase7-transform-provider-inventory.md`](../docs/phase7-transform-provider-inventory.de.md)
- [`../ARCHITECTURE.md`](../ARCHITECTURE.md) — Phase-7-Grenze
- [`./document-action-plan.md`](document-action-plan.de.md) — Originalbehandlung
