...
> **Router im Root:** [`../WORKFLOWS.md`](../WORKFLOWS.de.md) — enthält die
...
- ❌ „Ein 2-Schritt-Prozess" → zu klein; nutze einen Befehlsalias oder eine lokale Betriebsnotiz
...
- [`../SECURITY.de.md`](../SECURITY.de.md) — Sicherheitsgrenzen und Freigabe-Gates
