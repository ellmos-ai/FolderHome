...
[English](./calendar-connectors.md) | **Deutsch**
...
- [`../docs/phase27-calendar-connector-plan.md`](../docs/phase27-calendar-connector-plan.de.md)
- [`../skills/folderhome-calendar-connectors/SKILL.md`](../skills/folderhome-calendar-connectors/SKILL.md)
- [`calendar-handoff.md`](calendar-handoff.de.md)
