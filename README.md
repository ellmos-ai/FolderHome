...
[`Phase-36-Completion-Audit`](./docs/phase36-completion-audit.md). Während des
...
generierten [`WORKFLOWS.md`](./WORKFLOWS.md).
...
- Lizenzen und Pins: [`THIRD_PARTY_LICENSES.md`](./THIRD_PARTY_LICENSES.md)
